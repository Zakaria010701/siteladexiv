    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(isset($content['category_id']))
                    @if($allServices->count() > 0)
                        ...
                        <div class="bg-white border-2 border-blue-600 rounded-lg overflow-hidden shadow-lg mx-auto max-w-4xl"
                            style="border: 2px solid #2563eb !important; margin: 0 auto; padding: 0; width: 100%; display: block;">
                            <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-blue-600 scrollbar-track-blue-100"
                                ...
                                <table class="w-full min-w-full mx-auto" style="margin: 0 auto; min-width: 500px; max-width: 900px;">
                                    <thead>
    <tr style="background-color: #f2f2f2;"> <!-- erste Header-Zeile -->
        <!-- Name -->
        <th rowspan="2" 
            class="px-2 py-3 text-center text-sm font-bold text-blue-900 align-middle"
            style="border-right: 2px solid #2563eb !important;">
            Name
        </th>
        ...
        <th colspan="3" 
            ...
            style="border-left: 2px solid #2563eb !important; border-right: 2px solid #2563eb !important; border-bottom: 2px solid #2563eb !important;">
            Preis pro Behandlung beim Kauf von Paketen
        </th>
        ...
        <th rowspan="2" 
            class="px-2 py-3 text-center text-sm font-bold text-blue-900 align-middle"
            style="border-left: 2px solid #2563eb !important;">
            Kaufen
        </th>
    </tr>
    <tr style="background-color: #f2f2f2; border-bottom: 2px solid #2563eb !important;"> <!-- zweite Header-Zeile -->
        <th class="px-2 py-2 text-center text-sm font-bold text-blue-900"
            style="border-right: 2px solid #2563eb !important;">3</th>
        <th class="px-2 py-2 text-center text-sm font-bold text-blue-900"
            style="border-right: 2px solid #2563eb !important;">6</th>
        <th class="px-2 py-2 text-center text-sm font-bold text-blue-900"
            style="border-right: 2px solid #2563eb !important;">8</th>
    </tr>
</thead>
                                    ...
                                    <tbody>
                                        @foreach($allServices as $service)
                                            ...
                                            <tr class="hover:bg-blue-25 transition-colors" style="border-bottom: 1px solid #2563eb !important;">
                                                <td class="px-1 sm:px-2 py-3 align-top border-r-2 border-blue-600"
                                                ...
                                                <td class="px-1 py-3 text-center align-top border-r-2 border-blue-600" style="min-width: 40px;">
                                                    <div class="text-xs font-semibold text-gray-900">{{ number_format($singlePrice, 0, ',', '.') }}€
                                                    </div>
                                                </td>
                                                <td class="px-1 py-3 text-center align-top border-r-2 border-blue-600" style="min-width: 40px;">
                                                    <div class="text-xs font-semibold text-gray-900">
                                                        {{ number_format($package3Price, 0, ',', '.') }}€
                                                    </div>
                                                </td>
                                                <td class="px-1 py-3 text-center align-top border-r-2 border-blue-600" style="min-width: 40px;">
                                                    <div class="text-xs font-semibold text-gray-900">
                                                        {{ number_format($package6Price, 0, ',', '.') }}€
                                                    </div>
                                                </td>
                                                <td class="px-1 py-3 text-center align-top border-r-2 border-blue-600" style="min-width: 40px;">
                                                    <div class="text-xs font-semibold text-gray-900">
                                                        {{ number_format($package8Price, 0, ',', '.') }}€
                                                    </div>
                                                </td>
                                                <td class="px-1 sm:px-2 py-3 text-center align-top"
                                                    style="background-color: #f8f9fa; border: 1px solid #2563eb; min-width: 40px;">
                                                    <form action="{{ route('cart.add') }}" method="POST" class="inline">
                                                        @csrf
                                                        <input type="hidden" name="item_type" value="service">
                                                        <input type="hidden" name="item_id" value="{{ $service->id }}">
                                                        <button type="submit"
                                                            class="bg-blue-600 hover:bg-blue-700 text-white font-medium px-2 sm:px-4 py-2 sm:py-3 rounded-md transition-colors border border-blue-600 hover:border-blue-700 flex items-center justify-center w-full"
                                                            style="background-color: #2563eb !important; color: white !important; display: flex !important; visibility: visible !important; min-height: 36px;">
