            ...
            <div class="table-repeater-container rounded-xl relative ring-1 ring-gray-950/5 dark:ring-white/20">
                <table class="w-full">
                    ...
                    <tfoot @class([
                        ...
                        'table-repeater-header overflow-hidden border-b border-gray-950/5 dark:border-white/20' => $renderFooter,
                    ])>
                    <tr class="text-xs md:divide-x md:divide-gray-950/5 dark:md:divide-white/20">
                        @foreach ($headers as $key => $header)
                            <th
                                @class([
                                    'table-repeater-footer-column p-2 font-medium bg-gray-100 dark:text-gray-300 dark:bg-gray-900/60',
                                    match($header->getAlignment()) {
                                      'center', Alignment::Center => 'text-center',
                                      'right', 'end', Alignment::Right, Alignment::End => 'text-end',
                                      default => 'text-start'
                        ...
                        @endforeach
                        @if ($hasActions)
                            <th class="table-repeater-footer-column w-px p-2 bg-gray-100 dark:bg-gray-900/60">
                                <ul class="flex items-center table-repeater-row-actions gap-x-3 px-2">
