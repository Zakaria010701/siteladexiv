                ...
                <div>
                    @foreach ($containers as $uuid => $item)
                        ...
                        <li
                            ...
                            class="fi-fo-repeater-item rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 border-2 border-custom-600"
                        ...
                        >
                            @if ($isReorderableWithDragAndDrop || $isReorderableWithButtons || filled($itemLabel) || $isCloneable || $isDeletable || $isCollapsible || count($visibleExtraItemActions))
                                <div
                                    ...
                                    @class([
                                        'fi-fo-repeater-item-header px-4 py-3 overflow-hidden',
                                ...
                                >
                                    <div class="flex items-center gap-x-3">
                                        ...
                                        <p
                                            @class([
                                                'text-xs font-medium text-gray-950 truncate',
                                            ])
                                        >
                                            {{ $itemDate }}
                                        </p>
                                    ...
                                    @if (filled($itemLabel))
                                        <p
                                            @class([
                                                'text-xs font-medium text-gray-950 whitespace-pre-line break-words',
