...
class ServicePackagePolicy
{
    ...
    {
        return $user->can('delete_any_service::package');
    }
    ...
    {
        return $user->can('force_delete_any_service::package');
    }
    ...
    {
        return $user->can('restore_any_service::package');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, ServicePackage $servicePackage): bool
    {
        return $user->can('replicate_service::package');
    }
    ...
    {
        return $user->can('reorder_service::package');
    }
}
