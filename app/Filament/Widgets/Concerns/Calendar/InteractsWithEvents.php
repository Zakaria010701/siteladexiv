...
namespace App\Filament\Widgets\Concerns\Calendar;
...
trait InteractsWithEvents
{
     ...
     * @return bool Weather to revert the drop action.
     */
     ...
     * @return bool Wether to revert the resize action.
     */
    ...
    public function onSlotSelect(string $start, ?string $end, bool $allDay, ?array $view, ?array $resource): void
    {
        [$start, $end] = $this->calculateTimezoneOffset($start, $end, $allDay);
